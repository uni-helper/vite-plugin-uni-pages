...
/**
 * globalStyle 与 pageStyle 共有的配置项
 */
interface BaseStyle {
  /**
  ...
  /**
   * 顶部窗口的背景色（bounce 回弹区域），支持 HEX 颜色
   *
   * @default "#ffffff"
   *
   * @desc 仅 iOS 平台
  ...
  /**
   * 底部窗口的背景色（bounce 回弹区域），支持 HEX 颜色
   *
   * @default "#ffffff"
   *
   * @desc 仅 iOS 平台
  ...
  /**
   * 设置编译到 mp-alipay 平台的特定样式，配置项参考 [MP-ALIPAY](https://uniapp.dcloud.net.cn/collocation/pages#mp-alipay)
   *
   * 相应的类型是 MpAlipay
   *
   * @desc 支付宝小程序
  ...
  /**
   * 设置编译到 mp-weixin 平台的特定样式，配置项参考 [MP-WEIXIN](https://uniapp.dcloud.net.cn/collocation/pages#mp-weixin)
   *
   * 相应的类型是 MpWeixin
   *
   * @desc 微信小程序
  ...
  /**
   * 设置编译到 mp-baidu 平台的特定样式，配置项参考 [MP-BAIDU](https://uniapp.dcloud.net.cn/collocation/pages.html#mp-baidu)
   *
   * 相应的类型是 MpBaidu
   *
   * @desc 百度小程序
...
/**
 * globalStyle 节点的类型，用于设置应用的状态栏、导航条、标题、窗口背景色等
 */
export interface GlobalStyle extends BaseStyle {
  /**
   * 页面容器背景色，支持 HEX 颜色
   *
   * @desc App、H5、小程序
   ...
   * @format color
   */
  backgroundColorContent?: HEXColor | ThemeVar
   ...
   * @default false
   *
   * @desc App-nvue（vue3 固定值为 true） 3.2.13+、App 5.0+
   */
  dynamicRpx?: boolean
...
/**
 * pages 每个页面 style 节点的类型，用于设置每个页面的状态栏、导航条、标题、窗口背景色等
 *
 * 页面中配置项会覆盖 globalStyle 中相同的配置项
 */
export interface PageStyle extends BaseStyle {
  /**
   * 导航栏阴影，配置参考 [导航栏阴影](https://uniapp.dcloud.net.cn/collocation/pages#navigationbarshadow)
   *
   * 微信/百度/头条小程序需要配置: "disableScroll": true
   *
   * 支付宝小程序需要配置 "allowsBounceVertical": "NO"
   */
  navigationBarShadow?: {
    /**
     * 阴影颜色
     *
     * 支持 grey、blue、green、orange、red、yellow
     */
