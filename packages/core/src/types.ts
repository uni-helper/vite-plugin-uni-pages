...
export interface DefinePageOptions extends Partial<PageMetaDatum> {
  /**
   * 配置页面路径
...
export type MaybeCallable<T = any> = T | (() => T | Promise<T>)

export declare function definePage(options: MaybeCallable<DefinePageOptions>): void
